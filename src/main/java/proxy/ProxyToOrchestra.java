...
public class ProxyToOrchestra {
    ...
    @Inject
    private RequestHelperWithCookies requestHelper;
    ...
    public Set<SmallBranch> getAllBranches() {
        ...
        , urlCreator.getAllBranchesUrl(), httpHeaders);
    }
    ...
    public Branch getBranch(int branchId) throws EJBException, AuthFailedException {
        return requestHelper.getRequestAndReceiveObject(Branch.class, urlCreator.getBranchUrl(branchId), httpHeaders);
    }
    ...
    public AccountInfo getModulesForUser()    {
//        return requestHelper.getRequestAndReceiveGeneric(new GenericType<AccountInfo>() {}
//                , urlCreator.getModulesForUserUrl(), httpHeaders);
        return requestHelper.getRequestAndReceiveObject(AccountInfo.class
                , urlCreator.getModulesForUserUrl()
                , httpHeaders);
    }
